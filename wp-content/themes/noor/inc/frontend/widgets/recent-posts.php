...
class noor_recent_news extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            esc_html__('N Recent Posts', 'noor'), 

            // Widget description
            array( 'description' => esc_html__( 'N Recent Posts', 'noor' ), ) 
        );
    }
    ...
    <p>
        ...
        <label><?php esc_html_e( 'Number of posts to show:', 'noor' ); ?></label> 
    ...
    <p>
        <label>
            ...
            <?php esc_html_e( 'Show date time', 'noor' ); ?>
        </label>
    </p>
...
function noor_wpb_recent_news() {
	register_widget( 'noor_recent_news' );
}
add_action( 'widgets_init', 'noor_wpb_recent_news' );